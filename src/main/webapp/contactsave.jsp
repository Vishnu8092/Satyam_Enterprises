...
<body style="background: linear-gradient(180deg,#8bbca0,#5f658d);">
 ...
 <div class="col-md-6">
 <div class="mm" style="box-shadow: 0 0 6px 0;
    padding: 30px 40px;
    border-radius: 10px;
    background: white;
    margin-top: 229px;">
...
<center>
<h1 class="text-center" style="font-size:45px;">Submitted Successfully !!</h1>
<div class="col-md-12">
	 <a href="index.jsp" style="color:#233d9c;font-size:20px;text-decoration:none"><b>Back To Login Page !</b></a>	          
    </div>
    </center>
</div>
</div>
