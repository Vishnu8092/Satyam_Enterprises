	...
	<div class="mm">
		<div class="row">
			...
			<div class="col-md-10" >
				...
				<h4 style="color:#233d9c;font-size:30px;"><b> Register Successfully !! </b></h4>
		       <div class="row">
		            <div class="col-md-6">	
		           <a href="Login.jsp"><button type="Submit" value="login" name="btn" class="btn success" style="font-size:30px"><b>Login</b></button></a>	          
		            </div>
