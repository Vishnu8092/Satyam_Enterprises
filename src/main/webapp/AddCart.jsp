...
<section id="gg" style="padding:30px 40px;border-radious:10px;background:white;margin-top:229px;">
	<div class="mm">
		<div class="row">
			...
			<div class="col-md-10" >
				...
				<h4 style="color:#233d9c;font-size:30px;"><b> Add to Cart is Successfully !! </b></h4>
		       <div class="row">
		            <div class="col-md-6">	
		           <a href="Cart.jsp"><button type="Submit" value="login" name="btn" class="btn success" style="font-size:30px"><b>My Cart</b></button></a>	          
		            </div>
