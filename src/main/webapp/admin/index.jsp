...
<body style="background: linear-gradient(180deg,#8bbca0,#5f658d);">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="container" style="    box-shadow: 0 0 6px 0;
    padding: 30px 40px;
    border-radius: 10px;
    background: white;
    margin-top: 229px;">
				<form action="AdminLoginSub.jsp" method="post"><br>
				<h4 style="margin-left:150px;color:#233d9c;font-size:30px;"><b>ADMIN LOGIN</b></h4>
				
					<div class="col-md-12" style="color:#233d9c;font-size:25px;"><br> 
					<label for="" class="lal"><b>User Name<sup style="color:red">*</sup></b></label>             
		              <input type="text" required class="form-control" placeholder="User Name" name="Uname">
		            </div>
		           
		            <div class="col-md-12" style="color:#233d9c;font-size:25px;"><br> 
		            <label for="" class="lal"><b>Password<sup style="color:red">*</sup></b></label>            
		            ...
		            <div class="row">
		            <div class="col-md-6">	
		            <a href="Forgot.jsp" style="color:#233d9c;font-size:20px;text-decoration:none"><b>Forgot Password ?</b></a>	          
		            </div> 
		            <div class="col-md-6" style="display:flex; justify-content:center">
		            <button type="Submit" class="btn success" style="font-size:20px;" >Login</button>
		            </div> 
		            </div>
