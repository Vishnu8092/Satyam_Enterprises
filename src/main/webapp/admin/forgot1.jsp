...
<section id="forgot">
    ...
    background: white;
    margin-top: 229px;">
				<form action="For2.jsp" method="post"><br>
				<h4 style="margin-left:130px;color:#233d9c;font-size:30px;"><b>Forgot Password</b></h4>
		           ...
		           <div class="col-md-12" style="color:#233d9c;font-size:25px;"><br> 
		            <label for="" class="lal"><b>New Password<sup style="color:red;">*</sup></b></label>            
		            ...
		            <label for="" class="lal"><b>Confirm Password<sup style="color:red;">*</sup></b></label>            
		              <input type="password" required class="form-control" placeholder="Password" name="CPass">
		            </div>
