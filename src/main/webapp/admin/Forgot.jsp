...
<section id="forgot">
    ...
    background: white;
    margin-top: 229px;">
				<form action="forgotAction.jsp" method="post"><br>
				<h4 style="margin-left:130px;color:#233d9c;font-size:30px;"><b>Forgot Password</b></h4>
				
					<div class="col-md-12" style="color:#233d9c;font-size:25px;"><br> 
					<label for="" class="lal"><b>User Name<sup style="color:red;">*</sup></b></label>             
		              <input type="text" required class="form-control" placeholder="Enter Your Email" name="Uname">
		            </div>
		          ...
		          <div class="row">
		            <div class="col-md-6">	
		            <a href="index.jsp" style="margin-left:10px;color:#233d9c;font-size:20px;text-decoration:none"><b>Back To Login Page !</b></a>	          
		            </div>
		            
		            <div class="col-md-6" style="display:flex; justify-content:center">
		            <button type="Submit" class="btn success" style="font-size:23px;margin-left:50px;">Submit</button>
		            </div> 
		            </div>
